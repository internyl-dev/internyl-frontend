...
import { ChevronRight, Search, Cpu, Target, Github, Users, BookOpen, Lightbulb, ArrowRight, Sparkles, ExternalLink, Zap, Heart, Code2 } from 'lucide-react';
            ...
            <div className="bg-gradient-to-br from-orange-100/80 to-pink-100/80 backdrop-blur-sm border border-white/40 rounded-3xl p-10 shadow-xl hover:shadow-2xl transition-all duration-300 text-center">
              <div className="max-w-3xl mx-auto">
                ...
                <p className="text-gray-500 mt-4 text-sm">
                  (And now look what we&rsquo;ve built! Sometimes the best projects come from unexpected beginnings.)
                </p>
              </div>
            </div>
          </div>
