            ...
            <div className="space-y-4">
                ...
                {bugReport.bugSeverity && (
                    <div>
                        ...
                        <span
                            className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium border ${severity === "critical"
...
export default function AdminReports() {
    ...
    return (
        <div className="">
            <AdminNav title="Admin | Manage Reports" />
            <div className="max-w-8xl mx-auto p-6">
                ...
                {loading ? (
                    ...
                    <>
                        {reports.length === 0 ? (
                            <div className="text-center py-16 bg-white/30 backdrop-blur-lg rounded-lg shadow-sm">
                                <div className="text-gray-400 text-6xl mb-4">📋</div>
                                <h3 className="text-xl font-semibold text-gray-700 mb-2">No reports found</h3>
                                <p className="text-gray-500">Reports will appear here when users submit them.</p>
                            </div>
                        ) : (
                            <div className="bg-white/30 backdrop-blur-md rounded-lg shadow-lg overflow-hidden border border-white/20">
