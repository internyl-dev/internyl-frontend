...
const BrushStroke: React.FC<BrushStrokeProps> = ({
  ...
  const rectClipId = `${clipId}-rect`;
  const animId = `${clipId}-anim`;
  ...
  return (
    <>
      ...
      <div
        className={`brush-wrap ${className}`}
        style={wrapperStyles}
      >
        <div
          ref={pseudoRef}
      ...
      {/* SVG with clipPath and animation */}
      <svg
        height="0"
        width="0"
